...
export const Footer: React.FC = () => {
  return (
    <footer className="bg-bg-dark border-t border-border-dark text-text-on-dark-secondary py-12">
      <Container>
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-5 gap-8 pb-8 border-b border-border-dark">
          ...
          <div className="lg:col-span-2 space-y-4">
            ...
            <p className="text-xs text-text-on-dark-muted max-w-sm">
